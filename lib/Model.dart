class StudentLogin {
  ...
  StudentLogin( {required this.name,required this.PRN,required this.Semester,required this.Branch,
    //required this.Division,required this.Batch,
  ...
  factory StudentLogin.fromJson(Map<String, dynamic>? json){
    ...
    return StudentLogin(name:name,PRN:PRN, Branch: Branch,
...
class FacultyLogin {
  ...
  factory FacultyLogin.fromJson(Map<String, dynamic>? json) {
    ...
    List<String> subjects = subjectString.split(',').map((e) => e.trim()).toList();
...
class StudentList {
  ...
  StudentList(
      {//required this.Divison,
       // required this.semester, required this.branch, required this.subject,
        //required this.Batch
        this.name, this.branch, this.semester, this.PRN,this.isPresent = false
});
}
